...
//            qTitle: "Close"
            ...
            enabled: true
            onImageClicked: picker.close()
            onImageEntered: qToolTip.showMe(x, y, 2, "Close")
        }
...
//                console.log(folderListModel.folder.toString())
            ...
            onImageEntered: qToolTip.showMe(x, y, 2, "Select")
        }
...
//            qTitle: "Back"
            ...
            onImageEntered: qToolTip.showMe(x, y, 2, "Back")
        }
